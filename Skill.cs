...
namespace TechSkillAPI
{
    class Skills
    {
        Dictionary<string, string[]> suggestionDict = new Dictionary<string, string[]>
        {
            ...
            { "typescript ts", new string[3] { "Make a hello world program", "Use an interface in code", "Use a constant in a program" } },
            { "java", new string[3] { "Make an image editing program", "Create a shapes class", "Use inheritance in a java program"} },
            { "javascript js", new string[3] { "Use javascript to make a line in an html canvas", "Update an html element", "Make an API" } },
